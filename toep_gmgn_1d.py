...
from toep_gmgn import Toep_GMGN1D
...
if __name__ == '__main__':
    ...
    exp_nm = '-'.join(['Toep_GMGN1D', args.act, str(args.h), str(args.k), str(args.m), str(args.seed)])
    ...
    model = Toep_GMGN1D(n=args.n, m=args.m, k=args.k, kernel=kernel, device=device)
