...
from data import load_dataset_2dt
import argparse
import yaml 
import pprint
from utils import *
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description="Train a fourier neural operator 3d")
    ...
    tra_res = 64 //args.trasub
    test_res = 64 //args.testsub
    T_in = 10
    ...
    train_loader, test_loader, u_normalizer = load_dataset_2dt(args)
