...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description="Train DD Green MG Net")
    ...
    exp_nm = '-'.join(['DD_GMGN1D', args.act, str(args.h), str(args.k), str(args.m), str(args.seed)])
    ...
    model = DD_GMGN1D(n=args.n, m=args.m, k=args.k, kernel=kernel, device=device)
