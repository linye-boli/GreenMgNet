    ...
    do
        ...
        do
            ...
            do
                ...
                # baseline gl 
                python green_mgnet.py --device $device --task $task --act $act --seed $s --mode gl --lr_adam 1e-3 --ep_adam $ep --sch --h $h --res $res
                ...
                do
                    ...
                    do
                        # dd green mg
                        python green_mgnet.py --device $device --task $task --act $act --k $k --m $m --seed $s --mode dd_mg --lr_adam 1e-3 --ep_adam $ep --sch --h $h --res $res
                    done
                done
