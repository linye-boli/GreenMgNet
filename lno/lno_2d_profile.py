...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description="low-rank neural operator 2d profile")
    ...
    model_nm = f'lno2d-r{model_cfg.rank}-w{model_cfg.width}'+ \
               f'-{tra_res}-{test_res}'+ \
               f'-cl{args.clevel}-ml{mlevel}'
    
    log_root = os.path.join(data_cfg.plog_dir, gpu_nm, f'exp2d/lno2d/')
